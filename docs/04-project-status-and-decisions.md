...
WP01 is accepted. WP02 is accepted as the development foundation. G0 remains partially open pending repository/CI and company environment inventory. G1 remains open because collector work and real Windows evidence have not begun. WP03 is the next implementation package.
